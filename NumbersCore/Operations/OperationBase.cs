...
{
	// operartions have a transform flow that is measured in a time unit of 1. Other time units are powers of this transform basis.
	// There is an equality of all operations that are the same ops indepedent of parameterization, as they have the same base graph over time.
	...
	// it may be useful to have all angles defined relative to some horizontal/vertical as these matter, and can be lost in a ralative polyline.
