...
public class Transform : ITransform
{
  ...
  // the compounding flag has elements recombined together each step using running totals, like compound interest, e, etc
  ...
  /// Other ops, like GT, LT can also have repeats. Repeat of zero is just a comparison, with the result being the true part.
